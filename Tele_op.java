...
//------------------------------------------------------------------------------------
                ...
                if (gamepad1.x) {
                    robot.cargolights.setPattern(RevBlinkinLedDriver.BlinkinPattern.CP2_LIGHT_CHASE);
                } else {
                    robot.cargolights.setPattern(RevBlinkinLedDriver.BlinkinPattern.SKY_BLUE);
...
//------------------------------------------------------------------------------------
                ...
                telemetry.addData("BS", robot.blocksensor.alpha());
