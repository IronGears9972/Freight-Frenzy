...
public class AutonomousTest extends LinearOpMode {
	...
	public void runOpMode() {
		...
		Pose2d redE3 = new Pose2d(-27.5, -49, Math.toRadians(270));
		...
		Pose2d redGoalParking = new Pose2d(-28, -24, Math.toRadians(180));
		...
		while (opModeIsActive()) {
			...
			if(parking == 0){
				...
				Trajectory parkInGoal = drive.trajectoryBuilder(redGoalParking)
