...
public class PoseLibrary {
    ...
    public static Pose2d redGoalParking = 	    new Pose2d(-24,         -26,    Math.toRadians(180));
    ...
    public static Pose2d blueE3 = 			    new Pose2d(-26,         51,     Math.toRadians(90));
    ...
    public static Pose2d blueGoalAlliance = 	new Pose2d(-12,         36,     Math.toRadians(90));
    public static Pose2d blueGoalParking = 	    new Pose2d(-27,         24,     Math.toRadians(180));
    ...
    public static Pose2d blueOutOfWay = 		new Pose2d(-51.75,      24,    Math.toRadians(270));
    ...
    public static Vector2d redWarehouseInV = 	    new Vector2d(42,      -65);
