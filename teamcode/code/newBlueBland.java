...
public class newBlueBland extends LinearOpMode {
	...
	public void runOpMode() {
		...
		drive.setPoseEstimate(PoseLibrary.startblueBland);

		telemetry.addLine("step 1");
		telemetry.update();

		Trajectory gart = drive.trajectoryBuilder(PoseLibrary.startblueBland)
		...
		Trajectory firstTime02 = drive.trajectoryBuilder(firstTime01.end())
				.lineToLinearHeading(PoseLibrary.blueReading,
						SampleMecanumDrive.getVelocityConstraint(50, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
						SampleMecanumDrive.getAccelerationConstraint(35))
				.build();

		Trajectory cycling00 = drive.trajectoryBuilder(PoseLibrary.blueWarehouseIn)
				.lineToLinearHeading(PoseLibrary.blueWarehouseOut)
				.build();
