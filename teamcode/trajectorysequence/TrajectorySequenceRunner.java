...
public class TrajectorySequenceRunner {
    public static String COLOR_INACTIVE_TRAJECTORY = "#F0047F";
    public static String COLOR_INACTIVE_TURN = "#F0047F";
    public static String COLOR_INACTIVE_WAIT = "#F0047F";
        ...
        if (sequence != null) {
            for (int i = 0; i < sequence.size(); i++) {
                ...
                if (segment instanceof TrajectorySegment) {
                    ...
                    fieldOverlay.fillRect(pose.getX()-(width/2),pose.getY()-(height/2),width,height);
