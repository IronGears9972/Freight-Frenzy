...
public class Hardware_21_22 {
    ...
    public void PDrive(String direction, String bearing, double inches, double power){
        ...
        if (direction == "F"){
            frontLeftMotor.setPower(position);
            frontRightMotor.setPower(position);
            rearRightMotor.setPower(position);
            rearLeftMotor.setPower(position);
        }
