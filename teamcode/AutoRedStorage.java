...
@Autonomous(name="Red-DUCKSIDE2", group="Pushbot")
public class AutoRedStorage extends LinearOpMode {
	...
	public void runOpMode() {
		...
		while (opModeIsActive()) {
			...
			if (layer == 1) {
				robot.drivestrafe(-4, 0.25, "N/A");
				dist = -4;
			} else if (layer == 2) {
				robot.drivestrafe(4, 0.25, "N/A");
				dist = 4;
			} else if (layer == 3) {
				robot.drivestrafe(12, 0.25, "N/A");
				dist = 12;
			}
			robot.robotsleep(0);
			sleep(1000);
			...
			robot.drivestrafe(-(dist + 6), 0.3, "N/A");
			robot.robotsleep(0);
			sleep(500);
			robot.drivestraight(12,0.2);
			robot.robotsleep(0);
			sleep(500);
			robot.trunangel(65,0.5);
			robot.robotsleep(0);
			sleep(500);
			robot.drivestraight(18,0.2);
			robot.robotsleep(0);
			sleep(500);
			...
			robot.drivestraight(-40,0.2);
			robot.robotsleep(0);
			sleep(500);
			robot.drivestrafe(20,0.2, "");
			robot.robotsleep(0);
			sleep(500);
			break;
		}
